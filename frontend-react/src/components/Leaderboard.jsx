...
export default function Leaderboard(props) {
    ...
    return <>
        ...
        <Form.Select className="leaderboardSelector m-1" style={{ color: 'black', width: 'auto' }} onChange={(e) => props.setLeaderboardTab(e.target.value)} defaultValue={props.leaderboardTab}>
