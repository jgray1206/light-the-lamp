--num picks
select count(*) from public.pick p where team_id = 17 and game_id > '2023020000';

--most points, top 3
select points, user_id, reddit_username, display_name
from public.user u
JOIN (
select sum(points) as points, user_id from public.pick p where team_id = 17 and game_id > '2023020000' group by user_id
