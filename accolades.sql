...
--num users
select count(*) from (select count(*) from public.pick p where team_id = 17 and game_id > '2024020000' group by user_id);
...
JOIN public.team t ON p.team_id = t.id
where game_id > '2024020000' group by p.team_id;
