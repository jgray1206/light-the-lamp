...
CREATE TABLE "game" (id BIGINT NOT NULL PRIMARY KEY, "date" TIMESTAMP NOT NULL, game_state VARCHAR(20) NOT NULL, home_team_id BIGINT NOT NULL, away_team_id BIGINT NOT NULL, home_team_goals SMALLINT, away_team_goals SMALLINT, is_shootout BIT);
...
CREATE TABLE "pick" (id BIGINT generated always as identity, group_id BIGINT, user_id BIGINT NOT NULL, game_id BIGINT NOT NULL, game_player_id_game_id BIGINT, game_player_id_player_id BIGINT, goalies BOOLEAN, team BOOLEAN, points SMALLINT);
...
CREATE TABLE "user_user" (id BIGINT generated always as identity, from_user BIGINT NOT NULL, to_user BIGINT NOT NULL);
CREATE TABLE "user_team" (id BIGINT generated always as identity, team_id BIGINT NOT NULL, user_id BIGINT NOT NULL);
...
CREATE TABLE "announcer" (id BIGINT generated always as identity, team_id BIGINT NOT NULL, display_name VARCHAR(32) NOT NULL, nickname VARCHAR(32) NOT NULL);
