...
SET SCHEMA dbo;
CREATE TABLE "user" (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_id BIGINT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, confirmed BIT, locked BIT, attempts SMALLINT, ip_address VARCHAR(47) NOT NULL, confirmation_uuid VARCHAR(36) NOT NULL);
...
CREATE TABLE "pick" (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, group_id BIGINT, user_id BIGINT NOT NULL, game_id BIGINT NOT NULL, game_player_id_game_id BIGINT, game_player_id_player_id BIGINT, goalies BIT, team BIT, points SMALLINT);
