...
CREATE TABLE "user_user" (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, from_user BIGINT NOT NULL, to_user BIGINT NOT NULL);
CREATE TABLE "user_team" (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_id BIGINT NOT NULL, user_id BIGINT NOT NULL);
...
CREATE TABLE "pick" (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_id BIGINT NOT NULL, user_id BIGINT NOT NULL, game_id BIGINT NOT NULL, game_player_id_game_id BIGINT, game_player_id_player_id BIGINT, goalies BIT, the_team BIT, points SMALLINT);
