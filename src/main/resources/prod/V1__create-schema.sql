CREATE TABLE "user" (id SERIAL PRIMARY KEY, email VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, confirmed BIT, locked BIT, attempts SMALLINT, ip_address VARCHAR(47));
CREATE TABLE "group" (id SERIAL PRIMARY KEY, team_id BIGINT NOT NULL, name VARCHAR(128) NOT NULL);
