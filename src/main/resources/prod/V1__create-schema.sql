CREATE TABLE "user" (id SERIAL PRIMARY KEY, email VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, confirmed BOOLEAN, locked BOOLEAN, attempts SMALLINT, ip_address VARCHAR(47) NOT NULL, confirmation_uuid VARCHAR(36) NOT NULL);
