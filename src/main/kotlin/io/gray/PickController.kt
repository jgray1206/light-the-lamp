...
class PickController(
    ...
    @Post("/user/{gameId}/{pick}", consumes = [MediaType.APPLICATION_JSON])
    fun createForUser(@PathVariable gameId: String, @PathVariable pick: String, principal: Principal): Mono<Pick> {
